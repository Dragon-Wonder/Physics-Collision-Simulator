...
namespace Version{
	...
	#define DEFINED_VER_BUILDS_COUNT  1
	#define DEFINED_VER_RC_FILEVERSION 1,1,2,1
	#define DEFINED_VER_RC_FILEVERSION_STRING "1, 1, 2, 1\0"
	#define DEFINED_VER_FULLVERSION_STRING  "1.1.2.1"
